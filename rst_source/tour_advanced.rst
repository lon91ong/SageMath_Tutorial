...
:math:`Q` 或有限域上受到限制。例如，我们计算两条仿射平面曲线的并，
...
isogenies, much new code for curves over :math:`Q`, and some of Denis
...
-  EllipticCurve([:math:`a_1`, :math:`a_2`, :math:`a_3`, :math:`a_4`, :math:`a_6`]):
   ...
   :math:`a_1`. If all the :math:`a_i` have parent :math:`Z`, they are
   coerced into :math:`Q`.
...
:math:`(Z/N Z)^* \to R^*`, for some ring :math:`R`, to the map
:math:`Z \to R` obtained by sending those integers :math:`x`
...
:math:`\text{Gal}(Q(\zeta_N)/Q)` on these characters, as well
